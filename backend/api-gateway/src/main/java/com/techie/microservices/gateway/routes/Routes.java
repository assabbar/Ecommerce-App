...
public class Routes {
    ...
    public RouterFunction<ServerResponse> authServiceRoute() {
        return GatewayRouterFunctions.route("auth_service")
                .route(RequestPredicates.path("/api/auth/**"), HandlerFunctions.http(productServiceUrl))
    ...
    @Bean
    public RouterFunction<ServerResponse> imagesServiceRoute() {
        return GatewayRouterFunctions.route("images_service")
                .route(RequestPredicates.path("/api/images/**"), HandlerFunctions.http(productServiceUrl))
                .filter(CircuitBreakerFilterFunctions.circuitBreaker("imagesServiceCircuitBreaker",
                        URI.create("forward:/fallbackRoute")))
                .build();
    }
